...
image::logstash-7.17.fields-sample.png[Logstash 7.17示例]

* Logstash 8.23示例*

image::logstash-8.x.fields-sample.png[Logstash 8.23示例]
...
+
image::kibana-import-options.png[Kibana导入选项]

+
导入ELK <version>-query-chart -sample.ndjson。+当系统提示您解决冲突时、请选择您在第8步中创建的索引模式或数据视图。

+
image::kibana-import-conflict.png[Kibana冲突]
