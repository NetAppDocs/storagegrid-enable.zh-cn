...
+
image:ransomware-protection-create-endpoint.png["勒索软件保护创建端点"]
...
+
image:ransomware-protection-create-ilm-rule.png["勒索软件保护创建ILM规则"]

+
image:ransomware-protection-create-ilm-rule-step-2.png["勒索软件保护-cree-ilm-맦 퓲-step 2"]
