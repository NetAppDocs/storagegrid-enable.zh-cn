...
.步骤
. 在 link:veritas-configure-storagegrid-s3-object-lock.html#configure-storagegrid-s3-object-lock-default-bucket-retention["基本配置"] 部分中重复步骤 1-3，但这次选择"使用 S3 Object Lock 在 WORM 模式下存储数据"选项。单击"下一步"。
+
