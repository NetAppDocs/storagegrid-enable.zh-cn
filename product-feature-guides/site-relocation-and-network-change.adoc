...
.步骤
. 如果在新位置使用新的网格网络子网， link:https://docs.netapp.com/us-en/storagegrid/expand/updating-subnets-for-grid-network.html["将子网添加到网格网络子网列表"^]
...
. ssh 到设备并使用"shutdown -h now"关闭节点
